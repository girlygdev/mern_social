...
import { updateCurrentProfile, getCurrentProfile} from '../../actions/profile'
import { Link, withRouter } from 'react-router-dom'

const EditProfile = ({ profile: { profile, loading }, updateCurrentProfile, getCurrentProfile, history}) => {
  ...
  const onSubmit = e => {
    ...
    updateCurrentProfile(formData, history, true)
  }
