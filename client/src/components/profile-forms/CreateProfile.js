...
const CreateProfile = ({ updateCurrentProfile, history}) => {
  ...
  const onSubmit = e => {
    ...
    updateCurrentProfile(formData, history)
  }
...
export default connect(null, mapActionsToProps)(withRouter(CreateProfile))
